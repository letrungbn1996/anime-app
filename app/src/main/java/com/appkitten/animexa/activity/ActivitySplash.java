...
import static com.appkitten.animexa.Config.ALLOW_VPN_ACCESS;
import static com.appkitten.animexa.util.Constant.LOCALHOST_ADDRESS;
...
import com.appkitten.animexa.callback.CallbackSettings;
...
public class ActivitySplash extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!Objects.equals(sharedPref.getLanguageCode(), "default")){
            LocaleUtils.Companion.setLocale(ActivitySplash.this,sharedPref.getLanguageCode(),true);
        }else{
            Locale currentLocale = LocaleUtils.Companion.getCurrentLocale(ActivitySplash.this);
            LocaleUtils.Companion.setLocale(ActivitySplash.this,currentLocale.getLanguage(),false);
        }
