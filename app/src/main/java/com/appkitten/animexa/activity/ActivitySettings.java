...
public class ActivitySettings extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_set_language).setOnClickListener(new View.OnClickListener() {
            @Override
...
//        });
    ...
    protected void onResume() {
        super.onResume();
        TextView currentLang = findViewById(R.id.current_lang);
        selectedLanguage = sharedPref.getLanguage();
        currentLang.setText(selectedLanguage);
        if (!Objects.equals(selectedLanguage, "default")){
            LocaleUtils.Companion.setLocale(ActivitySettings.this,sharedPref.getLanguageCode(),true);
        }else{
            Locale currentLocale = LocaleUtils.Companion.getCurrentLocale(ActivitySettings.this);
            LocaleUtils.Companion.setLocale(ActivitySettings.this,currentLocale.getLanguage(),false);
        }
    }
}
